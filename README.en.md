# <img src="docs/evidence/icon-256.png" width="44" alt="app icon"> Steam Game Picker
...
The application icon is generated by a script — tweak the palette or the artwork and regenerate it:
